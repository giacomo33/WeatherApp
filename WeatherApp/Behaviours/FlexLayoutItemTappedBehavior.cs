...
namespace WeatherApp.Behaviours
{
    /// <summary>Behaviour implementation adding command properties for the Flexlayout control. Specifically adds tap command when a bindable layout is used.</summary>
